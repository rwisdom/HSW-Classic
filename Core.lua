...
local _TEST=nil;
local options = {
	name = "Healer Stat Weights (Classic)",
	handler = hsw,
	childGroups = "tab",
	type = "group",
	args = {
...
function hsw:OpenOptions()
	...
	hsw_frame:SetTitle("Healer Stat Weights (Classic)");
...
function hsw:OnInitialize()
	...
	self.optionsFrame = LibStub("AceConfigDialog-3.0"):AddToBlizOptions("HSW_Bliz", "Healer Stat Weights (Classic)");
